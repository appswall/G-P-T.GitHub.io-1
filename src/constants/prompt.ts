...
    name: '❤️Совместимость',
    prompt:
      'Меня зовут [ Ваше имя ], а моего друга [ имя друга ], какая у нас совместимость?',
  },
  {
    id: '2',
    name: '🤪Психолог',
    prompt:
      'Я хочу, чтобы ты действовал как психолог. я поделюсь с вами своими мыслями. Я хочу, чтобы ты дал мне научные предложения, которые помогут мне почувствовать себя лучше. моя первая мысль, [ набрав здесь свою мысль, если вы объясните более подробно, я думаю, вы получите более точный ответ. ]',
  },
  {
    id: '3',
    name: '👩‍⚖️Юрист',
...
    name: '💻Программист',
    prompt:
      'Предоставь пошаговые инструкции и напиши код - для [ тема ]?',
  },
  {
    id: '5',
    name: '🧑‍🍳Шеф-повар',
